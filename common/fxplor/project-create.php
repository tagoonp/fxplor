      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            ...
            <div class="card mt-3">
              <div class="card-body">
                <form class="project-create-form" onsubmit="return false;">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="txtCat" id="txtCat">
                      ...
                      <!-- <option value="">Maternal and Newborn Health</option> -->
                    </select>
                  </div>

                  <div class="form-group text-left">
                    <button type="submit" name="button" class="btn btn-primary btn-sm bsdn">Create</button>
                    <button type="reset" name="button" class="btn btn-sm bsdn">Reset form</button>
                  </div>
